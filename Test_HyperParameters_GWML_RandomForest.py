...
# Define ranges or lists for hyperparameters
hyperparameter_ranges = {
    'n_estimators': range(100, 1000),  # Example range for n_estimators
    'max_depth': range(5, 20),         # Example range for max_depth
    'max_features': range(5, 20),      # Example range for max_features
    'min_samples_split': range(2, 10), # Example range for min_samples_split
    'min_samples_leaf': range(1, 5),   # Example range for min_samples_leaf
    'max_leaf_nodes': range(50, 100),  # Example range for max_leaf_nodes
    'criterion': ['gini', 'entropy'],  # Example list for criterion
    'bootstrap': [True],        # Example list for bootstrap
    'min_impurity_decrease': [random.uniform(0, 0.1) for _ in range(10)],  # Example list for min_impurity_decrease
    'ccp_alpha': [random.uniform(0, 0.01) for _ in range(10)],            # Example list for ccp_alpha
    'max_samples': [random.uniform(0.1, 0.5) for _ in range(10)]          # Example list for max_samples
}

numbers = [x for x in range(1, 300)]# Perform 100 tries with different hyperparameters
for _ in numbers:
    # Randomly sample hyperparameters
    params = {param: random.choice(values) for param, values in hyperparameter_ranges.items()}
    ...
    print('############# End of set of hyperparameters ##############')
...
axes[0, 0].set_xlabel('Run for random hyper parameters')
...
axes[0, 1].set_xlabel('Run for random hyper parameters')
...
axes[1, 0].set_xlabel('Run for random hyper parameters')
...
axes[1, 1].set_xlabel('Run for random hyper parameters')
...
plt.tight_layout()
# plt.show()
plt.savefig('Test_Hyperparameters_change_RandomForest.jpg')
plt.close()