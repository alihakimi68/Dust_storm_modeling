...
hyperparameter_ranges = {
    'n_estimators': range(50, 1000),        # Adjusted range for n_estimators
    'max_depth': range(5, 15),              # Adjusted range for max_depth
    'learning_rate': np.linspace(0.1, 0.3, 10),  # Adjusted range for learning_rate
    'gamma': np.linspace(0.5, 1.5, 10),          # Adjusted range for gamma
    'subsample': np.linspace(0.7, 1.0, 10),      # Adjusted range for subsample
    'colsample_bytree': np.linspace(0.6, 0.8, 10),# Adjusted range for colsample_bytree
    'reg_alpha': np.linspace(0.5, 1.0, 10),       # Adjusted range for reg_alpha
    'reg_lambda': np.linspace(0.5, 1.0, 10)       # Adjusted range for reg_lambda
}
...
plt.tight_layout()
# plt.show()
plt.savefig('Test_Hyperparameters_change_XGBoost.jpg')
plt.close()