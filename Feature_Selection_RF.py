...
print(f'The best estimator for {FeatureCount} features is {best_estimator} ')
...
n_estimators_values = [50, 100, 150, 200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500]
# n_estimators_values = np.arange(270, 330)
rf_classifier = RandomForestClassifier(n_estimators=best_estimator, random_state=42)  # You can adjust parameters as needed
